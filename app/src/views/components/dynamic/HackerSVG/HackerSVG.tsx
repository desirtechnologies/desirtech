    ...
    const ComputerScreenText = () => {
        return (
            <path
                ...
                fill="#008000"
                class="group-hover:animate-pulse repeat-infinite"
    ...
    const RightArmSleve = () => {
        return (
            <path
                ...
                fill="#fff"
                id={`right-arm-sleve`}
                class={`fill-white duration-500 ease-in-out group-hover:fill-black`}
            />
        )
    }
        ...
        return (
            <>
                <path
                    ...
                    fill="#3F3D56"
                    class="duration-500 ease-in-out hover:translate-x-4"
                />
                <path
                    opacity={0.1}

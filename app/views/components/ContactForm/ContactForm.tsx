const ContactForm = () => {
    ...
    return (
        <section className="py-26  relative overflow-hidden">
            ...
            />
            <img
                className="absolute top-0 md:h-full right-0 w-1/2"
                src="nigodo-assets/background-elements/pattern-circle-big-indigo-light-right.svg"
                alt=""
            />
                        ...
                        <div className="flex flex-wrap -mx-4">
                            ...
                            <div className="w-full sm:w-1/2 px-4">
                                ...
                                <div className="flex items-center">
                                    <a
                                        className="inline-block mr-6 text-gray-400 hover:text-gray-500"
                                        href="#"
                                    >
                                        <svg
                                            width={10}
